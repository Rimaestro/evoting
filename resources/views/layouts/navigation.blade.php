<nav x-data="{ open: false }" class="bg-white/5 border-b border-white/10 backdrop-blur-lg">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-300 bg-white/10 hover:text-white focus:outline-none transition ease-in-out duration-150">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('profile.edit')" class="flex items-center">
                            <x-lucide-user-cog class="w-4 h-4 mr-2"/>
                            {{ __('Profile') }}
                        </x-dropdown-link>
